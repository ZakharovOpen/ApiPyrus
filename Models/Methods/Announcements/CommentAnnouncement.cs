...
{
    public class CommentAnnouncement
    {
        private PyrusRequestTask _entityForJson = new PyrusRequestTask();
        public CommentAnnouncement(long announcementId)
            => _announcementId = announcementId;

        private long _announcementId;

        /// <summary>
        /// Комментировать объявление в Pyrus.
        /// </summary>
        public async Task<AnnouncementInfo> Send(ApiClient apiClient, string extRequestId = "")
            => await apiClient.CommentAnnouncement(_entityForJson.GetJson(), _announcementId, extRequestId);
        ...
        /// </summary>
        public CommentAnnouncement AddText(string text, bool formatedText = false)
        {
            if (formatedText)
        ...
        /// </summary>
        public CommentAnnouncement AddAttachments(List<Guid> attachments)
        {
        ...
        /// </summary>
        public CommentAnnouncement AddAttachments(List<string> attachments)
        {
            _entityForJson.AttachmentsList = attachments;
            return this;
        }
        ...
        /// </summary>
        public CommentAnnouncement AddAttachments(List<ValueAttachmentData> attachments)
        {
            _entityForJson.AttachmentsList = attachments;
            return this;
        }
        ...
        /// </summary>
        public async Task<CommentAnnouncement> AddAttachments(string fullFileName, ApiClient apiClient)
        {
